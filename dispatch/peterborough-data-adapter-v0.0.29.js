const SOURCE_ROOT = new URL('./vendor/', import.meta.url).href;
...
async function initialize() {
  await loadScript('peterborough-package-v1.6.66.js', 'city-package');
  ...
  await loadScript('dispatch-data-v1.4.20.js', 'dispatch-data');
  const rawCalls = await window.PTBO_DISPATCH_DATA_READY;
