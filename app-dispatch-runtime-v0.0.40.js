...
function dispatchSpawnAtCoordinates(spawn) {
  ...
  state.viewer.camera.setView({destination:Cesium.Cartesian3.fromDegrees(lon,lat,340),orientation:{heading:state.vehicle.heading,pitch:-1.12,roll:0}});
  refreshSurfaceHeight(); updateTruckEntity(); recenterCamera();
