...
window.__CITY_DEMO_RUNTIME__ = Object.freeze({ spawnAtCoordinates:dispatchSpawnAtCoordinates, getViewer:()=>state.viewer&&!state.viewer.isDestroyed()?state.viewer:null, snapshot: () => ({
