...
const turboButton=document.createElement('button');turboButton.id='turbo-button';turboButton.type='button';turboButton.textContent='TURBO';turboButton.setAttribute('aria-pressed','false');turboButton.style.cssText='position:fixed;z-index:11500;right:7px;top:50%;transform:translateY(-50%);padding:5px 7px;min-width:0;border:1px solid #78cfff;border-radius:7px;background:#071923cc;color:#dff7ff;font:800 9px/1 system-ui;letter-spacing:.06em;opacity:.72';document.body.append(turboButton);
